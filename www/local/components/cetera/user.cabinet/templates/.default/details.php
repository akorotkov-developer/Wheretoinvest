...
<div class="row">
    ...
    <div class="columns req req_p">
        <div class="row">
            ...
            <div
                class="req__value medium-6 small-7 columns js-detail-uf_ogrn"><?= !empty($userInfo["UF_OGRN"]) ? $userInfo["UF_OGRN"] : "<span class='req__name'>—</span>"; ?></div>
        </div>
    </div>
    <div class="columns req">
        <div class="row">
            ...
            <div
                class="req__value medium-6 small-7 columns js-detail-uf_license"><?= !empty($userInfo["UF_LICENSE"]) ? $userInfo["UF_LICENSE"] : "<span class='req__name'>—</span>"; ?></div>
        </div>
    </div>
    <div class="columns req">
        <div class="row">
            ...
            <div
                class="req__value medium-6 small-7 columns js-detail-uf_inn"><?= !empty($userInfo["UF_INN"]) ? $userInfo["UF_INN"] : "<span class='req__name'>—</span>"; ?></div>
        </div>
    </div>
    <div class="columns req">
        <div class="row">
    ...
    <div class="columns req req_p">
        <div class="row">
            ...
            <div
                class="req__value medium-6 small-7 columns js-detail-uf_account"><?= !empty($userInfo["UF_ACCOUNT"]) ? $userInfo["UF_ACCOUNT"] : "<span class='req__name'>—</span>"; ?></div>
        </div>
    </div>
    <div class="columns req">
        <div class="row">
            ...
            <div
                class="req__value medium-6 small-7 columns js-detail-uf_bank_info"><?= !empty($userInfo["UF_BANK_INFO"]) ? $userInfo["UF_BANK_INFO"] : "<span class='req__name'>—</span>"; ?></div>
        </div>
    </div>
    <div class="columns req">
        <div class="row">
            ...
            <div
                class="req__value medium-6 small-7 columns js-detail-uf_bik"><?= !empty($userInfo["UF_BIK"]) ? $userInfo["UF_BIK"] : "<span class='req__name'>—</span>"; ?></div>
        </div>
    </div>
    <div class="columns req">
        <div class="row">
