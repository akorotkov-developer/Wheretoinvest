    ...
    ath.intl = {
        ...
        ru: {
            ios: {
                ...
                message: 'Нажмите %icon и выберите <br/> <strong>На экран «Домой»</strong>'
            },
            android: {
                title: "Быстрый доступ к сайту <br> «Куда&nbsp;вложить»",
                message: 'Откройте меню браузера %icon <br/> и нажмите <br/> <strong>Добавить на главный экран</strong>',
            }
        },
...
// falls back to en_us if language is unsupported
    ath.language = ath.language && ath.language in ath.intl ? ath.language : 'ru';
