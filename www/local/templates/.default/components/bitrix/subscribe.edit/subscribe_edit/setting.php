    ...
    <div class="row">
        <div class="column small-12 medium-12 large-12">
            ...
            <div class="subscribe">
                ...
                <div class="row">
                    ...
                    <div class="column small-3 medium-3 large-5">
                        <div class="row">
                            ...
                            <div class="column small-12 medium-12 end">
                                <span data-tooltip aria-haspopup="true" class="has-tip subscribe__hint subscribe__hint-mt" title="<?echo GetMessage("subscr_settings_note1")?><br><?echo GetMessage("subscr_settings_note2")?>"></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="column small-12 medium-12 end">
                                ...
                                <div class="subscribe__wrp">
                                    <input type="checkbox" name="RUB_ID[]" id="RUB_ID_<?=$itemValue["ID"]?>" class="subscribe__checkbox"
                                           value="<?=$itemValue["ID"]?>" <?if($itemValue["CHECKED"]) echo " checked"?> />
                                    <label for="RUB_ID_<?=$itemValue["ID"]?>" class="subscribe__chck"><?=$itemValue["NAME"]?></label>
                                </div>
                                <?endforeach;?>
                            </div>
                        </div>
                            ...
                            <div class="column small-12 medium-12 end">
                                <div class="row">
                                    ...
                                    <div class="column small-6 medium-5 large-4">
                                        ...
                                        <label class="subscribe__rdo" for="FORMAT_text"><?echo GetMessage("subscr_text")?> </label>
                                    </div>
                ...
                <div class="row">
                    <div class="column small-12 medium-12 large-12">
                        <button type="submit" name="Save" class="content__submit"><?echo ($arResult["ID"] > 0? GetMessage("subscr_upd"):GetMessage("subscr_add"))?></button>
                        <button type="reset" name="reset" class="subscribe__reset"><?echo GetMessage("subscr_reset")?></button>
                    </div>
                </div>
