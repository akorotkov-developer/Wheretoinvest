            ...
            <div class="subscribe subscribe__no-padding">
                <div class="subscribe__border-b">
                    ...
                    <div class="column small-3 medium-3 large-7">
                        <span
                            class="<? echo($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y" ? "notetext" : "errortext") ?>"><? echo($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y" ? GetMessage("subscr_yes") : GetMessage("subscr_no")); ?></span>
                    </div>
                </div>
                <div class="subscribe__border-b">
                    <div class="column small-9 medium-9 large-5">
                    ...
                    <div class="column small-3 medium-3 large-7">
                        <span
                            class="<? echo($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y" ? "notetext" : "errortext") ?>"><? echo($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y" ? GetMessage("subscr_yes") : GetMessage("subscr_no")); ?></span>
                    </div>
                </div>
                <div class="subscribe__border-b">
                    <div class="column small-9 medium-9 large-5">
