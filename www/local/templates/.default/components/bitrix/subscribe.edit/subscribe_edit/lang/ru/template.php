...
$MESS ['subscr_status_note3'] = "Если вы хотите отписаться от рассылок, нажмите на кнопку <span style='color: #f30f3a'>Отписаться</span>.";
$MESS ['subscr_status_note4'] = "Ваша подписка подтверждена, но не активна.";
$MESS ['subscr_status_note5'] = "Если вы хотите возобновить рассылки, нажмите на кнопку <span style='color: #f30f3a'>Активизировать</span>.";
