...
$MESS ['subscr_upd'] = "Сохранить изменения";
...
$MESS ['subscr_settings_note1'] = "После изменения электронного адреса подписки, на новый адрес будет направлено письмо. <br>Перейдите по ссылке в этом письме для подтверждения нового адреса подписки.";
$MESS ['subscr_settings_note2'] = "Подписка будет не активной до подтверждения.";
