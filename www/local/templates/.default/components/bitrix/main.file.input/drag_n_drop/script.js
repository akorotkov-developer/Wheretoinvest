(function () {
    ...
    window.BlogBFileDialog = function (arParams) {
        ...
        if (!!BX.FileUploadAgent) {
            ...
            BX.debug('/local/templates/.default/components/bitrix/main.file.input/drag_n_drop/script.js: BX.FileUploadAgent is not defined.' +
    ...
    window.BlogBFileDialog.prototype.CreateFileRow = function (result) {
        var res = result;
        var mode = 'file';
        if (!!res.element_content_type && (res.element_content_type.indexOf('image/') == 0) && !!res.element_image && (res.element_image.length > 0) && !!res.element_thumbnail && (res.element_thumbnail.length > 0)) {
            mode = 'image';
        }
    ...
    window.BlogBFileDialog.prototype.tplFileRow = function (nodes, res) {
        for (id in nodes) {
            ...
            if ((id == 'image') && !!res.element_image && (res.element_image.length > 0) && !!res.element_thumbnail && (res.element_thumbnail.length > 0)) {
...
// upoader section
    ...
    window.MFIDD = function (params) {
        BX.loadCSS('/local/templates/.default/components/bitrix/main.file.input/drag_n_drop/style.css');
