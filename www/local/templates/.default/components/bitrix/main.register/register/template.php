...
<?else:?>
	...
	<li class="tab-title active"><a href="#panel1">Обычный пользователь</a></li>
	<li class="tab-title"><a href="#panel2">Партнер</a></li>
	...
	<div class="tabs-content">
		...
		<div class="content active" id="panel1">
			<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
				...
				?>
					...
					<input type="text" id="REGISTER[PERSONAL_BIRTHDAY]" name="REGISTER[PERSONAL_BIRTHDAY]" value="<?=$arResult["VALUES"]["PERSONAL_BIRTHDAY"];?>">
					<?
					...
					?>
					<label>Ваше имя для сайта</label>
					...
					<p class="help-text">Будет логином на сайт</p>
		...
		<div class="content" id="panel2">
			...
			<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
				...
				<input size="30" type="text" name="REGISTER[WORK_COMPANY]" value="<?=$arResult["VALUES"]["WORK_COMPANY"];?>">
				...
				<fieldset>
					...
					<label>Дата рождения</label>
					<input type="text" id="REGISTER[PERSONAL_BIRTHDAY2]" name="REGISTER[PERSONAL_BIRTHDAY]" value="<?=$arResult["VALUES"]["PERSONAL_BIRTHDAY"];?>">
					<?
					...
					$APPLICATION->IncludeComponent(
						...
						array(
							'SHOW_INPUT' => 'N',
							'FORM_NAME' => 'regform',
							'INPUT_NAME' => 'REGISTER[PERSONAL_BIRTHDAY2]',
							'SHOW_TIME' => 'N'
						),
						null,
						array("HIDE_ICONS"=>"Y")
					...
					<input size="30" type="text" name="REGISTER[PERSONAL_MOBILE]" value="<?=$arResult["VALUES"]["PERSONAL_MOBILE"];?>">
					<label>Контактный email</label>
					<input size="30" type="text" name="REGISTER[EMAIL]" value="<?=$arResult["VALUES"]["EMAIL"];?>">
					<p class="help-text">Будет логином на сайт. Вы должны иметь к нему доступ, чтобы подтвердить регистрацию</p>
					<label>Придумайте пароль</label>
					<input type="password" name="REGISTER[PASSWORD]" value="<?=$arResult["VALUES"]["PASSWORD"];?>">
